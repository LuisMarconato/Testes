...
def TROCA():
    ...
    if verifica_servicos_firebird()==True:
        ...
        #1.5.4.3- APRESENTAR MENSAGEM INDICADONDO STATUS
...
def DELETE_VERSAO():
    ...
    if verifica_servicos_guard() == False:    
        ...
        #3.6.4- APRESENTAR MENSAGEM INDICANDO STATUS
...
#1.9- BARRA DE PRROGRESSO ****(não esta funcionando direito, PRECISO REVISAR!)
...
#3.4- BOTÃO SALVAR SENHA ***(NÃO DEFINI A POSIÇÃO DO BOTÃO SALVAR SENHA AINDA, PRECISO REVISAR!)
#salva_senha = Button(text='SALVAR SENHA',height=1,width=15,command=SALVAR_SENHA)
#salva_senha.pack(fill="both", expand="yes")

#4- VALIDAR PARA DESABILITAR O BOTÃO REVERTER  (APRIMORAR VARREDURA PARA HABILITAR BOTÕES DE AÇÕES)
if combo == 0:
